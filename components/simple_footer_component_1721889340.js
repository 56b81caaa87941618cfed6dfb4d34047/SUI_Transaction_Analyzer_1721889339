...
*/
Vue.component("simple_footer_component_1721889340", {
    template: `
                ...
                <div id="footer-content" class="text-center">
                    <div class="flex">
                        <a id="footer-logo-link" href="#" class="flex-1 flex items-center justify-center mb-5 text-2xl font-semibold text-gray-900 dark:text-white">
                            ...
                            SuiExplorer - Analyse Sui Transactions
                        </a>
                    </div>
                </div>
                <div class="flex">
                    <div id="footer-text" class="flex-1 block text-sm text-center text-gray-500 dark:text-gray-400">
                        Stay up-to-date with the latest Sui blockchain transactions. SuiExplorer provides real-time analysis and insights into new blocks, transactions, and smart contracts on the Sui network.
                    </div>
                </div>
            </div>
        </footer> 
